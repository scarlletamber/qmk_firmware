...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* Base */
		...
		KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_ESC , KC_ESC, KC_BSPC, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
		KC_ESC , KC_LGUI, KC_APP , KC_LALT,                   KC_LOEN ,        KC_RASP,       KC_RALT   , KC_APP , KC_RGUI, KC_RCTL
  ),

  [_LOWER] = LAYOUT(
		KC_GRV , KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, JP_LCBR,         JP_RCBR, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, JP_CIRC, KC_AT  ,
