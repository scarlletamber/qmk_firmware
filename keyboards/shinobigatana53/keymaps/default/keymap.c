...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
		...
		_______, _______, _______, _______,                   _______,         ADJT,          _______, _______, _______, _______ ),
  ...
  [_RAISE] = LAYOUT(
		...
		_______, _______, _______, _______,                   ADJT,          _______,         _______, _______, _______, _______ ),

 [_ADJUST] = LAYOUT(
		RESET  , _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______,          _______, RGB_TOG, RGB_HUD, RGB_VAD, RGB_SAD, KC_F10 , KC_F11 ,
		_______, _______, _______, _______, _______, _______, _______,          _______, _______, RGB_MOD, RGB_HUI, RGB_VAI, RGB_SAI, XXXXXXX,
