...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	* |ESC/FN|LGUI |MENU  |LALT | ENTER/LOWER | SPACE/RAISE | RALT |RGUI |RCTRL |
	...
	[_DEFAULT] = KEYMAP(
		...
		ESC_FN , KC_LGUI, KC_APP, KC_LALT       , SPC_LW, ENT_RS           , KC_RALT, KC_RGUI, KC_RCTL),
	 ...
	 */
	[_LOWER] = KEYMAP(
		KC_GRV , KC_EXLM, KC_AT,   KC_HASH, KC_DLR , KC_PERC            , KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, JP_CIRC, KC_AT,
		_______, JP_GRV , JP_BSLS, KC_MINS, JP_EQL , JP_LBRC            , JP_RBRC, JP_SCLN, JP_ASTR, KC_SLSH, _______,
		_______, _______, JP_PIPE, JP_UNDS, JP_PLUS, JP_LCBR , _______  , JP_RCBR, JP_COLN, JP_LT  , JP_GT  , JP_QUES,
	 ...
	 * |-------------------------------------------------------------------------|
	 * |      |  1  |  2  | 3   | 4   | 5   |xx|     | LEFT |DOWM|UP  |RIGHT     |
	 * |-------------------------------------------------------------------------|
	 * |     |  6  |  7  | 8   | 9   | 0   |     | F10 | F11 | F12 |     |       |
 	 * |-------------------------------------------------------------------------|
	 * |NumPad|     |     |      |    ADJUST   |            |      |      |      |
	 * '-------------------------------------------------------------------------'
	 */
	[_RAISE] = KEYMAP(
		...
		_______, KC_1, KC_2 , KC_3 ,KC_4 , KC_5          ,KC_F4 , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT,
		_______, KC_6, KC_7 , KC_8 ,KC_9 , KC_0 , _______,KC_F10, KC_F11 , KC_F12, _______, _______,
